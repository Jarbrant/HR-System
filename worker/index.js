...
}
{
  "id": "training_prompt",
  "version": "1.0.0",
  "description": "Quality rules for generating distinct, valid training questions. Used by worker to enforce uniqueness and prevent placeholder/context leakage.",
  "questionQuality": {
    "general": {
